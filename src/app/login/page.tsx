      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 border border-white/20">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <button
              type="button"
              className="flex items-center justify-center px-4 py-2.5 sm:py-3 border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition-all hover:border-gray-300 hover:shadow-md group"
            >
