...
export default function RegisterPage() {
  ...
  useEffect(() => {
    const checkEmail = async () => {
      ...
      try {
        const response = await fetch(`/api/v1/auth/check-email?email=${encodeURIComponent(formData.email)}`);
  ...
  useEffect(() => {
    const checkPhone = async () => {
      ...
      try {
        const response = await fetch(`/api/v1/auth/check-phone?phone=${encodeURIComponent(formData.phone)}`);
        const data = await response.json();
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-100 px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="w-full max-w-md relative z-10">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-3 sm:py-3.5 border-2 rounded-xl focus:ring-2 focus:ring-purple-500 transition-all outline-none text-sm sm:text-base bg-white/50 text-gray-900 placeholder:text-gray-400 ${
                    emailAvailable === false ? 'border-red-400 focus:border-red-500' : emailAvailable === true ? 'border-green-400 focus:border-green-500' : 'border-gray-200 focus:border-purple-500'
                  }`}
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-3 sm:py-3.5 border-2 rounded-xl focus:ring-2 focus:ring-purple-500 transition-all outline-none text-sm sm:text-base bg-white/50 text-gray-900 placeholder:text-gray-400 ${
                    phoneError || phoneAvailable === false ? 'border-red-400 focus:border-red-500' : phoneAvailable === true ? 'border-green-400 focus:border-green-500' : 'border-gray-200 focus:border-purple-500'
                  }`}
                ...
                <div className="absolute inset-y-0 right-0 pr-4 flex items-center">
                  ...
                  {!phoneChecking && (phoneAvailable === false || phoneError) && (
                    <svg className="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
                    </svg>
                  )}
                ...
                <div className="mt-3 space-y-2">
                  ...
                  {passwordStrength.feedback.length > 0 && (
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-2">
                      <p className="text-xs font-medium text-blue-900 mb-1.5">Password must include:</p>
        ...
        <p className="text-center text-xs sm:text-sm text-gray-600 mt-6 sm:mt-8">
          ...
          <a href="/terms" className="text-purple-600 hover:text-purple-700 font-medium">Terms</a>
          {' '}and{' '}
          <a href="/privacy" className="text-purple-600 hover:text-purple-700 font-medium">Privacy Policy</a>
        </p>
      </div>
