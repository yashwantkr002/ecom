...
export default function RegisterPage() {
  ...
  useEffect(() => {
    const checkPhone = async () => {
      ...
      // Check if phone contains only numbers, +, -, spaces, and parentheses
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!phoneAvailable) {
      setError("This phone number is not available");
      return;
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-100 px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 border border-white/20">
          ...
          <div className="text-center mb-8 sm:mb-10">
            <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl mb-4 sm:mb-6 shadow-lg">
              <svg
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-3 sm:py-3.5 border-2 rounded-xl focus:ring-2 focus:ring-purple-500 transition-all outline-none text-sm sm:text-base bg-white/50 text-gray-900 placeholder:text-gray-400 ${
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 sm:py-3.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all outline-none text-sm sm:text-base bg-white/50 text-gray-900 placeholder:text-gray-400"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-12 pr-10 py-3 sm:py-3.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all outline-none text-sm sm:text-base bg-white/50 text-gray-900 appearance-none cursor-pointer"
                >
            ...
            {/* Success Message */}
            {success && (
              <div className="bg-green-50 border-2 border-green-200 text-green-700 px-4 py-3 rounded-xl text-sm flex items-start space-x-2 animate-slide-up">
                <svg
                  className="w-5 h-5 flex-shrink-0 mt-0.5"
                  fill="currentColor"
                  viewBox="0 0 20 20"
